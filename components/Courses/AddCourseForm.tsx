...
import { addNewSubject } from '@/redux/subjects/actions'
import { addeNewCourse } from '@/redux/courses/actions'
...
const AddCourseForm = () => {
	...
	const loading = useSelector((state: RootState) => state.course.isLoading)
	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			...
			try {
				...
				dispatch(addeNewCourse(formData))
			} catch (error: any) {
